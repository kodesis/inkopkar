...
class Koperasi_Management_m extends CI_Model
{
    ...
    var $column_order = array('id', 'no_induk', 'nama_koperasi', 'alamat', 'telp', 'saldo_rekening'); //set column field database for datatable orderable
    var $column_search = array('id', 'no_induk', 'nama_koperasi', 'alamat', 'telp', 'saldo_rekening'); //set column field database for datatable searchable 
