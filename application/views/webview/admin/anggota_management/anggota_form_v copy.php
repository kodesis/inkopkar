        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Form Layout <?= $this->session->userdata('id_koperasi') ?></h3>
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select" name="role" id="kasir_edit">
                                                            ...
                                                            <option <?= $Anggota->role == 5 ? 'selected' : '' ?>
                                                                value="5">Puskopkar</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div id="puskopkar-field-edit" style="display: none;">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="text">Puskopkar</label>
                                                            <select class="choices form-control" name="id_puskopkar" id="id_puskopkar_edit">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        ?>
                                                            <select id="koperasi-field-edit" style="display: none;" class="choices form-control" name="id_toko">
                                                                <option disabled selected>-- Pilih Koperasi --</option>
                                                                <?php
                                                                foreach ($koperasi as $c) {
                                                                ?>
                                                            ...
                                                            <select id="toko-field-edit" class="choices form-control" name="id_toko" style="display: none;">
                                                                <option disabled>-- Pilih Toko Koperasi --</option>
                                                                <?php
                                                                foreach ($koperasi as $c) {
                                                                ?>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="text">Toko Koperasi</label>
                                                        <select id="toko-field-edit" class="choices form-control" name="id_toko">
                                                            <option disabled selected>-- Pilih Toko Koperasi --</option>
                                                            <?php
                                                            foreach ($toko as $c) {
                                                            ?>
