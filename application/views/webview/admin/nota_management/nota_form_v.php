                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group position-relative has-icon-left">
                                                    <input type="number" class="form-control" id="nominal_kredit_add" name="nominal_kredit" onchange="cek_nominal()" onfocus="removeFormat(this)" onblur="formatNumber(this)" disabled>
