                                    ...
                                    <div class="blog__post-two shine-animate-item">
                                        ...
                                        <div class="blog__post-content-two">
                                            <div class="blog-post-meta">
                                                <ul class="list-wrap">
                                                    <li>
                                                        <a href="<?= base_url('blog') ?>" class="blog__post-tag-two">Audit</a>
                                                    </li>
                                                    <li><i class="fas fa-calendar-alt"></i>Oct 21, 2024</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="blog__post-two shine-animate-item">
                                        ...
                                        <div class="blog__post-content-two">
                                            <div class="blog-post-meta">
                                                <ul class="list-wrap">
                                                    <li>
                                                        <a href="<?= base_url('blog') ?>" class="blog__post-tag-two">Investment</a>
                                                    </li>
                                                    <li><i class="fas fa-calendar-alt"></i>Oct 21, 2024</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="blog__post-two shine-animate-item">
                                        ...
                                        <div class="blog__post-content-two">
                                            <div class="blog-post-meta">
                                                <ul class="list-wrap">
                                                    <li>
                                                        <a href="<?= base_url('blog') ?>" class="blog__post-tag-two">Agency</a>
                                                    </li>
                                                    <li><i class="fas fa-calendar-alt"></i>Oct 21, 2024</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="blog__post-two shine-animate-item">
                                        ...
                                        <div class="blog__post-content-two">
                                            <div class="blog-post-meta">
                                                <ul class="list-wrap">
                                                    <li>
                                                        <a href="<?= base_url('blog') ?>" class="blog__post-tag-two">Corporate</a>
                                                    </li>
                                                    <li><i class="fas fa-calendar-alt"></i>Oct 21, 2024</li>
                                                </ul>
                                            </div>
                                ...
                                <div class="sidebar__post-list">
                                    <div class="sidebar__post-item">
                                        <div class="sidebar__post-thumb">
                                            <a href="<?= base_url('blog/detail') ?>"><img src="<?= base_url() ?>assets/img/blog/sb_post01.jpg" alt=""></a>
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h5 class="title"><a href="<?= base_url('blog/detail') ?>">deno weuine easiure and praising</a></h5>
                                            <span class="date"><i class="flaticon-time"></i>Sep 15, 2024</span>
                                        </div>
                                    </div>
                                    <div class="sidebar__post-item">
                                        <div class="sidebar__post-thumb">
                                            <a href="<?= base_url('blog/detail') ?>"><img src="<?= base_url() ?>assets/img/blog/sb_post02.jpg" alt=""></a>
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h5 class="title"><a href="<?= base_url('blog/detail') ?>">know how to pursue pleasure rationally</a></h5>
                                            <span class="date"><i class="flaticon-time"></i>Sep 15, 2024</span>
                                        </div>
                                    </div>
                                    <div class="sidebar__post-item">
                                        <div class="sidebar__post-thumb">
                                            <a href="<?= base_url('blog/detail') ?>"><img src="<?= base_url() ?>assets/img/blog/sb_post03.jpg" alt=""></a>
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h5 class="title"><a href="<?= base_url('blog/detail') ?>">there anyone who loves</a></h5>
                                            <span class="date"><i class="flaticon-time"></i>Sep 15, 2024</span>
                                        </div>
                                    </div>
                                    <div class="sidebar__post-item">
                                        <div class="sidebar__post-thumb">
                                            <a href="<?= base_url('blog/detail') ?>"><img src="<?= base_url() ?>assets/img/blog/sb_post04.jpg" alt=""></a>
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h5 class="title"><a href="<?= base_url('blog/detail') ?>">deno weuine easiure and praising</a></h5>
                                            <span class="date"><i class="flaticon-time"></i>Sep 15, 2024</span>
