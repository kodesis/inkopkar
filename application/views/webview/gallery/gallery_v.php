            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="breadcrumb__content">
                        <h2 class="title">Semua Gallery</h2>
                            ...
                            <div class="row gutter-24">
                                ...
                                ?>
                                        <div class="col-md-4">
                                            <div class="blog__post-two shine-animate-item">
                                                <div class="blog__post-thumb-two">
                                                    <img src="<?= base_url('uploads/gallery/' . $b->thumbnail) ?>" alt="">
                                                </div>
                                                <!-- <div class="blog__post-content-two">
                                                    ...
                                                    <h2 class="title"><a href="<?= base_url('gallery/detail/' . $b->Id) ?>"><?= $b->title ?></a></h2>
                                                </div> -->
                                            </div>
                                        </div>
                                    <?php
                                    ...
                                    ?>
                                            <div class="sidebar__post-item">
                                                <div class="sidebar__post-thumb">
                                                    <a href="blog-details.html"><img src="<?= base_url('uploads/gallery/' . $r->thumbnail) ?>" alt=""></a>
                                                </div>
                                                <div class="sidebar__post-content">
                                                    <h5 class="title"><a href="<?= base_url('gallery/detail/' . $r->Id) ?>"><?= $r->title ?></a></h5>
