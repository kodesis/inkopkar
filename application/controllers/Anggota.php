...
class Anggota extends CI_Controller
{
    ...
    public function detail_saldo_simpanan($id)
    {
        $anggota = $this->anggota_management->get_id_edit($id);
        $data['Anggota'] = $anggota;
        // $toko = $this->toko_management->get_id_edit($anggota->id_toko);
        $koperasi = $this->koperasi_management->get_id_edit($anggota->id_koperasi);
        $data['koperasi'] = $koperasi;
        $saldo_simpanan = $this->anggota_management->get_id_saldo_simpanan($id);
        $data['saldo_simpanan'] = $saldo_simpanan;
        $data['content']     = 'webview/admin/nota/saldo_simpanan_v';
        $data['content_js'] = 'webview/admin/nota/saldo_simpanan_js';
        $this->load->view('parts/admin/Wrapper', $data);
    }
